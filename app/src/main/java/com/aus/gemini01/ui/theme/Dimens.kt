 ...
 *
 * Scale: 4dp base grid (4/8/12/16/24/32/48).
 */
object Dimens {
    ...
    val gutterReading = 24.dp   // reader / long-form content

    // Corner radii — one rhythm for cards, chips, dialogs, inputs
    val radiusS = 8.dp
    val radiusM = 12.dp
    val radiusL = 16.dp
    val radiusXL = 24.dp        // pills, chat bubbles, search field
    ...
    // Content
    val articleImageAspectRatio = 16f / 9f   // responsive image area, no fixed height
    val readingMeasureMax = 640.dp   // max comfortable line length for reader view

    // Component specifics
    val cardVerticalSpacing = 12.dp
